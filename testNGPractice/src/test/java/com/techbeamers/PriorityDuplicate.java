...
public class PriorityDuplicate {
	 ...
	 * Both methods have same name just before last character. Since '1' in
	 * DuplicatePriorityMethod1 will have lower ASCII then '2' in
	 * DuplicatePriorityMethod2. So DuplicatePriorityMethod1 will be run first
	 * followed by DuplicatePriorityMethod2.
	 */
