...
public class PriorityMixed {
	...
	// TestNG will assign priority as zero to this method
	/*
	 * There is tie between PrintWithoutPriority and DispWithoutPriority. So TestNg
	 * will use here ASCII rule to decide which method to be run first. Since ASCII
	 * of 'D' is 68 and ASCII of 'P' is 80. So method DispWithoutPriority will be
	 * executed first as it has lowest ASCII.
	 */
	@Test
